...
TEST(GeometryTest, SpanIntersects) {
  EXPECT_TRUE(Span(1.0f, 5.0f).Intersects(Span(1.0f, 2.0f)));
  EXPECT_TRUE(Span(1.0f, 5.0f).Intersects(Span(2.0f, 2.0f)));
  EXPECT_TRUE(Span(1.0f, 5.0f).Intersects(Span(2.0f, 5.0f)));
  EXPECT_TRUE(Span(1.0f, 5.0f).Intersects(Span(2.0f, 6.0f)));
  EXPECT_FALSE(Span(1.0f, 5.0f).Intersects(Span(6.0f, 7.0f)));
}
