...
#ifndef CPU_INSTRUCTIONS_BASE_CLEANUP_INSTRUCTION_SET_H_
#define CPU_INSTRUCTIONS_BASE_CLEANUP_INSTRUCTION_SET_H_
...
#endif  // CPU_INSTRUCTIONS_BASE_CLEANUP_INSTRUCTION_SET_H_
