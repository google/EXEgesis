...
#ifndef CPU_INSTRUCTIONS_ITINERARIES_DECOMPOSITION_H_
#define CPU_INSTRUCTIONS_ITINERARIES_DECOMPOSITION_H_
...
#endif  // CPU_INSTRUCTIONS_ITINERARIES_DECOMPOSITION_H_
